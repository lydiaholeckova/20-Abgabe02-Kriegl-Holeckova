 ...
 * This Class tests GenericQueue for Datatype Integer
 */
@DisplayName("Testing GenericQueue Class")
public class GenericQueueTest {

        private GenericQueue<Integer> genQ;
        /**
        ...
        public void testOffer() {
            assertFalse(genQ.offer(8));
            assertFalse(genQ.offer(37));
        ...
        public void testElement() {
            assertEquals(8, genQ.element());
            genQ.poll();
            assertEquals(37, genQ.element());
            genQ.poll();
            assertThrows(NoSuchElementException.class, () -> {
                genQ.element();
            });
